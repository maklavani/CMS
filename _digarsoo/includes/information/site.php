...
class Site {
	...
	{
		if(str_replace(_ADM , '' , dirname($_SERVER['PHP_SELF'])) != '/')
			return str_replace(_ADM , '' , dirname($_SERVER['PHP_SELF']) . '/');
		return '/';
	}
	...
	{
		if(str_replace(static::$base . _ADM , "" , static::get_full_link()) == "")
			return true;
		if(str_replace(static::$base . _ADM . 'index.php' , "" , static::get_full_link()) == "")
			return true;
		return false;
	}
