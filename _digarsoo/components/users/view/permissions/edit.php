...
$defualt_groups = array();
foreach (explode(',' , $params[0]->groups) as $value)
	if(!in_array($value , array(1 , 2)))
		$defualt_groups[] = $value;
...
$permissions = array(0 => array('type' => 'text' , 'name' => 'name' , 'default' => $params[0]->name) , 1 => array('type' => 'list' , 'name' => 'groups' , 'children' => $groups , 'default' => $defualt_groups , 'attributes' => 'multiple' , 'language' => false));
