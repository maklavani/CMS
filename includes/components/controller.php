...
class Controller {
	...
	public static function read_component()
	{
		...
		if(class_exists($class))
		{
			...
			if(System::has_file('components/' . Components::$name . '/details.json'))
			{
	...
	public static function check_view()
	{
		if(self::$view)
			...
			System::has_file('components/' . Components::$name . '/view/' . $_GET['view'] . '/view.php'))
		{
			self::$view = $_GET['view'];
			return true;
		}
	...
	public static function set_action()
	{
		if(!self::$action)
		{
			if(	isset($_GET['action']) && 
				...
				System::has_file('components/' . Components::$name . '/view/' . self::$view . '/' . $_GET['action'] . '.php'))
	...
	{
		if(System::has_file('components/' . Components::$name . '/model/' . $model . '/model.php'))
		{
